...
locals {
  ...
  kql_database_postgresqlflexible_resources_details_summary = templatefile(
    "${path.module}/template_kql/database/database_postgresqlflexible_resources_details_summary.kql",
    {
      "extend_resource" = local.kql_extend_resource
    }
  )
